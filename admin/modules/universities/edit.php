                    ...
                    <div class="form-group" style="margin-top:12px;">
                        <div
                            ...
                            <div style="display:flex; gap:8px;">
                                <button type="button" class="btn-sm action-btn" onclick="selectAllCourses(true)"
                                    style="padding:3px 10px; font-size:11.5px;">Select All</button>
                                <button type="button" class="btn-sm action-btn" onclick="selectAllCourses(false)"
                                    style="padding:3px 10px; font-size:11.5px;">Clear All</button>
                            </div>
                        </div>

                        <div
                            style="display:grid; grid-template-columns: repeat(auto-fill, minmax(180px, 1fr)); gap:10px; padding:14px; background:rgba(255,255,255,0.02); border:1px solid var(--border-color); border-radius:8px;">
                            <?php
                            $rendered_codes = [];
                            foreach ($all_master_courses as $c):
                                ...
                                ?>
                                <label
                                    style="display:flex; align-items:center; gap:8px; padding:6px 10px; background:var(--bg-card); border:1px solid var(--border-color); border-radius:6px; cursor:pointer; font-size:13px; transition:border 0.2s;">
                                    <input type="checkbox" name="allowed_courses[]"
                                        value="<?php echo htmlspecialchars($c_code); ?>" class="course-checkbox" <?php echo $is_chk ? 'checked' : ''; ?>>
                                    <span
                                        style="font-weight:600; color:var(--text-main);"><?php echo htmlspecialchars($c_code); ?></span>
                                    <span
                                        style="font-size:10.5px; color:var(--text-dim); margin-left:auto;"><?php echo htmlspecialchars($c['level']); ?></span>
                                </label>
                            <?php endforeach; ?>
                            ...
                            <label
                                style="display:flex; align-items:center; gap:8px; padding:6px 10px; background:var(--bg-card); border:1px solid var(--border-color); border-radius:6px; cursor:pointer; font-size:13px;">
                                <input type="checkbox" name="allowed_courses[]" value="Other" class="course-checkbox"
                                    <?php echo $is_other_chk ? 'checked' : ''; ?>>
                        ...
                        <span style="font-size:11.5px; color:var(--text-dim); margin-top:6px; display:block;">Select the
                            courses that should appear in this university's lead capture form dropdown.</span>
                    </div>
                </div>
            </div>
        </div>
