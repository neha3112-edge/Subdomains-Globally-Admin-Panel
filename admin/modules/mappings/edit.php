                        ...
                        <?php else: ?>
                            ...
                            ?>
                                <div class="spec-row" style="display:grid; grid-template-columns: 2.2fr 1.6fr 1fr 1fr 40px; gap:12px; align-items:start;">
                                        ...
                                        <select name="spec_name_select[]" class="form-control spec-select" onchange="onSpecSelectChanged(this)" style="background:var(--bg-card, #0f172a); font-size:13px;">
                                            ...
                                            <?php if (!empty($s_name) && !$found_in_master): ?>
                                                <option value="<?php echo htmlspecialchars($s_name); ?>" selected>
                                                    <?php echo htmlspecialchars($s_name); ?> (Custom)
                                                </option>
                                            <?php endif; ?>
                                            <option value="__custom__">+ Enter Custom Specialization...</option>
                                        </select>
                                        <input type="text" name="spec_name[]" class="form-control spec-name-custom" value="<?php echo htmlspecialchars($s_name); ?>" style="<?php echo (!$found_in_master && !empty($s_name)) ? 'display:block; margin-top:5px;' : 'display:none; margin-top:5px;'; ?> background:var(--bg-card, #0f172a); font-size:12.5px;" placeholder="Type custom specialization...">
                                    </div>
                                    ...
                                    <input type="text" name="spec_duration[]" class="form-control spec-duration-input" value="<?php echo htmlspecialchars($s['duration'] ?? ''); ?>" placeholder="Duration">
                                    <button type="button" class="action-btn delete-btn remove-spec-btn" title="Remove">&times;</button>
                                </div>
                            <?php endforeach; ?>
                        <?php endif; ?>
