...
require_action_permission('update', 'universal_news');
...
if (!$news_item) {
    set_flash_message('Universal announcement not found.', 'error');
    redirect(BASE_URL . '/modules/universal_news/index.php');
}

$page_title = 'Edit Universal Announcement';
$page_subtitle = 'Update global announcement details for all university subdomains';
...
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 24px; flex-wrap: wrap; gap: 12px;">
    <div>
        ...
        <h2 style="font-size: 22px; font-weight: 800; color: var(--text-color); margin: 0;">Edit Universal Announcement #<?php echo $id; ?></h2>
    </div>
</div>

<div class="admin-card" style="max-width: 900px; margin: 0 auto 30px auto;">
    <div class="card-header">
        <span class="card-title">Edit Announcement Details</span>
    ...
    <div class="card-body" style="padding: 24px;">
        <form method="POST" action="">
            ...
            <div style="background: rgba(59, 130, 246, 0.1); border-left: 4px solid var(--accent-color); padding: 12px 16px; border-radius: 6px; margin-bottom: 22px; font-size: 13px; color: var(--text-color); line-height: 1.5;">
                🌐 <strong>Universal Announcement:</strong> Changes made here will update on <strong>ALL university subdomains</strong> immediately across both Home Page and Inner Pages.
            </div>
            ...
            <div class="form-group" style="margin-bottom: 22px;">
                ...
                <textarea name="news_text" id="field_news_text" class="form-textarea" rows="3" placeholder="e.g. Admission Deadline Extended to 15th October 2026 for the latest academic session." required style="font-size: 14px; line-height: 1.5;"><?php echo htmlspecialchars($news_item['news_text']); ?></textarea>
                ...
                <div style="margin-top: 10px; background: rgba(255,255,255,0.03); border: 1px solid var(--border-color); border-radius: 8px; padding: 12px 14px;">
                    ...
                    <div style="display: flex; flex-wrap: wrap; gap: 6px;">
                        <!-- System Tags -->
                        <button type="button" class="tag-pill-btn" onclick="insertTag('{UNIVERSITY_NAME}', 'field_news_text')" title="Replaced with university name">
                            {UNIVERSITY_NAME}
                        </button>
                        <button type="button" class="tag-pill-btn" onclick="insertTag('{UNIVERSITY_SHORT_NAME}', 'field_news_text')" title="Replaced with university short code">
                        ...
                        <button type="button" class="tag-pill-btn" onclick="insertTag('$session$', 'field_news_text')" title="Admission session">
                            $session$
                        </button>
                        <button type="button" class="tag-pill-btn" onclick="insertTag('$nextyear$', 'field_news_text')" title="Next year">
                            $nextyear$
                        </button>
            ...
            <div class="form-group" style="margin-bottom: 22px;">
                ...
                <textarea name="description" id="field_description" class="form-textarea" rows="4" placeholder="e.g. {UNIVERSITY_NAME} has extended the admission deadline for the academic session. Students can submit the application form before 15th October 2026." style="font-size: 14px; line-height: 1.5;"><?php echo htmlspecialchars($news_item['description'] ?? ''); ?></textarea>
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="news_link" class="form-control" value="<?php echo htmlspecialchars($news_item['news_link'] ?? ''); ?>" placeholder="https://.../admission or #">
                <div style="font-size: 12px; color: var(--text-dim); margin-top: 4px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 20px;">
                <div class="form-group">
                    ...
                    <label style="display: flex; align-items: center; gap: 8px; margin-top: 8px; cursor: pointer;">
                        <input type="checkbox" name="has_badge" value="1" <?php echo !empty($news_item['has_badge']) ? 'checked' : ''; ?>>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="badge_text" class="form-control" value="<?php echo htmlspecialchars($news_item['badge_text'] ?? 'New'); ?>" placeholder="New">
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 24px;">
                <div class="form-group">
                    ...
                    <input type="number" name="sort_order" class="form-control" value="<?php echo (int)($news_item['sort_order'] ?? 0); ?>">
                ...
                <div class="form-group">
                    ...
                    <label style="display: flex; align-items: center; gap: 8px; margin-top: 8px; cursor: pointer;">
                        <input type="checkbox" name="is_active" value="1" <?php echo !empty($news_item['is_active']) ? 'checked' : ''; ?>>
