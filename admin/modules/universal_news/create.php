    ...
    <div class="card-body" style="padding: 24px;">
        <form method="POST" action="">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="published_date" id="field_published_date" class="form-control" value="<?php echo date('F j, Y'); ?>" placeholder="e.g. September 12, 2026" required style="font-size: 14px;">
