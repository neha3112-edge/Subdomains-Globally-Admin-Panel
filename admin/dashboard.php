...
<div class="dash-hero">
    ...
    <div class="dash-hero-right">
        ...
        <div style="display:flex; gap:8px;">
            ...
            <a href="<?php echo BASE_URL; ?>/modules/trash/index.php" class="btn-sm" style="text-decoration:none; display:inline-flex; align-items:center; gap:6px; background:var(--bg-input); border:1px solid var(--border-color); color:var(--text-main);">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path></svg>
                Trash <?php $tc = function_exists('get_trash_count') ? get_trash_count() : 0; if ($tc > 0): ?><span class="badge badge-danger" style="font-size:10px; padding:2px 6px; border-radius:10px;"><?php echo $tc; ?></span><?php endif; ?>
            </a>
        </div>
    </div>
</div>
