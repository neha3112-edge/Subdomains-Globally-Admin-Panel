<?php
/**
 * Universal API: Get Course Syllabus (Semester-wise Data)
 * Endpoint: /admin/api/get_course_syllabus.php
 */
...
$cache_key = 'api:course_syllabus:' . md5($uni_param . '|' . $course_param . '|' . $mode_clean);
...
if ($db) {
    try {
        ...
        error_log("get_course_syllabus error: " . $e->getMessage());
    }
}

$response_data = [
    'success'         => !empty($semesters),
