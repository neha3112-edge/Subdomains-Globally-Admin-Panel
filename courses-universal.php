        ...
        <div class="sode-courses-container" id="<?php echo esc_attr($unique_id); ?>">
            ...
            <div class="sode-courses-tabs-nav">
                <?php if ($atts['show_all'] === 'yes' || ($has_master && $has_bachelor)): ?>
                    <button type="button" class="sode-course-tab-btn <?php echo ($active_tab === 'all') ? 'active' : ''; ?>"
                        data-target-tab="all">
                        All Programs
                    </button>
                <?php endif; ?>
                <?php if ($has_master): ?>
                    <button type="button" class="sode-course-tab-btn <?php echo ($active_tab === 'Master') ? 'active' : ''; ?>"
                        data-target-tab="Master">
                        Master
                    </button>
                <?php endif; ?>
                <?php if ($has_bachelor): ?>
                    <button type="button" class="sode-course-tab-btn <?php echo ($active_tab === 'Bachelor') ? 'active' : ''; ?>"
                        data-target-tab="Bachelor">
                        Bachelor
                    </button>
                <?php endif; ?>
            </div>
            ...
            <div class="sode-courses-grid">
                <?php foreach ($courses as $c):
                    ...
                    ?>
                    <div class="sode-course-card" data-category="<?php echo $tab_type; ?>"
                        ...
                        <div class="sode-course-card-inner">
                            ...
                            <div class="sode-course-footer">
                                <div class="sode-course-meta">
                                    <svg class="sode-course-cal-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor"
